...
- [ ] Phase 3 — Tab/controller routing fixes are in repository main; battle/editor pause focus is now implemented locally and regression-tested. Main-menu/HQ Settings keyboard focus is now implemented locally and regression-tested; controller page visibility (PAUSE-06), broader input ownership, shared menu, and runtime acceptance remain pending.
