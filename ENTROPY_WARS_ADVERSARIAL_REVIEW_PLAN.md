...
**Current continuation:** use the LIFE-09 rematch consent delivery above before the older resume notes. LIFE-05 acknowledgement remains the next implementation; do not restart the completed clock, credential, deadline or consent batches.
