...
### The vessel-assignment screen becomes one CRT monitor · rev 5 (2026-09-09 — Stages 1–4 SHIPPED: the monitor, the tabs, the row, the circuit, the technique panel, the move preview, the VFX on the stage, the hero that CHARGES + the camera that frames it, the ROSTER wall; Stage 5 next)
