const ThreeRenderer = (function () {
    ...
    function _hzThemeRoster(name) {
        if (!_HZ_THEME_ROSTERS) _HZ_THEME_ROSTERS = {
            ...
            orbs: [
                [0.38, _hzAstralOrbs, true, -0.55, 0.75], [0.58, _hzSacredRings, true, -0.55, 0.70],
                [0.74, _hzModelEyeball, true, -0.45, 0.65], [0.90, _hzMonolith, false, -0.50, 0.55],
                [1.00, _hzFloatingIsland, false, -0.55, 0.60]],
            eyes: [
            ...
            islands: [
                [0.30, _hzFloatingIsland, false, -0.55, 0.65], [0.55, _hzMountain, false, -0.25, 0.30],
                [0.70, _hzStairway, false, -0.45, 0.55], [0.85, _hzGreekRuin, false, -0.40, 0.50],
                [1.00, _hzAstralOrbs, true, -0.50, 0.70]],
            city: [
            ...
            space: [
                [0.30, _hzAstralOrbs, true, -0.60, 0.76], [0.52, _hzCrystalShards, true, -0.60, 0.70],
                [0.72, _hzFloatingIsland, false, -0.58, 0.66], [0.84, _hzModelEyeball, true, -0.50, 0.70],
                [1.00, _hzSacredRings, true, -0.60, 0.72]],
            dark: [
