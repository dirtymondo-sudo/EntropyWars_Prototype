...
**Current implementation — Phase 9.3 expansion: THE ROUTES + THE WORLD
...
→ 9.1 finds → 9.5 portable thresholds → 9.4 encounters. THE SUITES are DONE
(rev 9, 2026-09-15). THE WELLS + THE
CAVE (9.3, rev 8) are next — data + the rev 6 builder. Optional 9.8
...
**Not done / next.** The cave's stage 2 (a ROCK shell — `kind: 'cave'` —
