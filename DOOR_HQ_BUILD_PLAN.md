...
- **Two floors in ONE room (stage 2, renderer) — SHIPPED 2026-09-15 rev
  ...
  refuses a 2.9 m drop). NOT BUILT: 8.4's THIRD RING on the rotunda (the
  same layer on `_hqWallR` / `HQ_LEVELS`), natives on the slab, a
...
- **THE SEAMS THAT ARE NOT DOORS (the user, 2026-09-15 rev 5: "a
  ...
  | `train` / `subway` | a platform; the train arrives and the next station is another map | **SHIPPED 2026-09-15 rev 21**: Room 2's tunnel (the platform, a FREE end on the track) ⇄ 2047 Cyberpunk (the north wall, half inside it) on THE SUBWAY route; Downtown and CERN wait on a free north lane (rev 10's lane rule) |
