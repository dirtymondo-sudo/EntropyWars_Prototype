...
- **THE USER'S RULE (2026-09-15 rev 16, decided — Part C row 35): NO
  RANDOM ENCOUNTERS. The officer starts every fight: with THE DOOR GUN
  DRAWN (9.5), throw the walker's ATTACK animation (1) or one of their
  SPELL animations (2 · 3 · 4) at a native in reach → the room is the
  board. Holstered, the natives are people you talk to. STAGE 1 SHIPPED
  ...
  three-renderer.js `_hqStrikeKey` (the one-shot on the walker's rig,
...
- **35 · encounters are never random (9.4, 2026-09-15 rev 16 — DECIDED
  by the user).** The officer initiates: the attack or a spell animation
  with the door gun drawn, at a native in reach. Open for the user: the
  keys (1–4 today), whether a holstered gesture should stay a flourish or
  do nothing, and whether a won room should stay quiet for the day.
