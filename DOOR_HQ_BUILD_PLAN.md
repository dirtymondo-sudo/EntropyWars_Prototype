...
**Current implementation — Phase 9.3 stage 1, local delivery.** The user asked
...
**Reviewed order:** 9.3 stage 1 (multiple exits + a reversible pilot) →
9.2 stage 1 (first complex) → 9.3 expansion (routes, suites and directory)
