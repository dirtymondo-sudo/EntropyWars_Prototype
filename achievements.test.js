...
test('mergeProgressBlobs: sanitizes hostile/garbage input', () => {
    ...
    assert.deepStrictEqual(norm(merge(null, undefined)), { v: 2, counters: {}, champs: {}, records: {}, unlocked: {}, hq: { finds: { taken: {} }, links: { seen: {} }, rooms: { seen: {} }, cleared: {}, encounters: { count: 0, wins: 0, losses: 0, last: null }, skate: { best: null, total: 0, lines: 0, bails: 0 } } });   // hq.finds: THE LEDGER; cleared / encounters / skate: THE SYNCED BUILDING (2026-09-16)
});
