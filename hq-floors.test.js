...
test('the secret doors: six panels on no plate, each pointing at a real door on the far side, none in the hall', () => {
    ...
    assert.strictEqual(secrets.length, 12, 'twelve secret doors (THE CAPTAIN’S SKYLIGHT between the Dutchman’s deck and its cabin — AREA CONTENT D3, 2026-09-19; before it ten: (the cave\u2019s oubliette shares a wall with Room 24601 — 2026-09-15 rev 10; THE CARGO HATCH between the Spaceship\u2019s deck and its hold — AREA CONTENT D3, 2026-09-19)');
    ...
    assert.strictEqual(pairs, 'bathroom→crawlspace coldroom→corridor_b corridor_b→coldroom crawlspace→bathroom deadend→dungeon deadend→hwing_e dungeon→site_prebuilt_hollow_earth_oubliette site_prebuilt_derelict_deck→site_prebuilt_derelict_hold site_prebuilt_derelict_hold→site_prebuilt_derelict_deck site_prebuilt_hollow_earth_oubliette→dungeon site_prebuilt_revenge_cabin→site_prebuilt_revenge_deck site_prebuilt_revenge_deck→site_prebuilt_revenge_cabin', 'the loops + THE CARGO HATCH + THE CAPTAIN’S SKYLIGHT (AREA CONTENT D3, 2026-09-19)');
});
