...
test('the secret doors: six panels on no plate, each pointing at a real door on the far side, none in the hall', () => {
    ...
    assert.strictEqual(secrets.length, 46, 'forty-six secret doors (THE PARKING GARAGE, 2026-09-26: the garage\u2019s H-Wing stair is gone \u2014 H-Wing is hard to find; before it forty-seven: THE THREE ROOMS, 2026-09-21: the crawlspace \u21c4 THE THIRTEENTH FLOOR pair; before it forty-five: THE ROUND GARAGE, 2026-09-20: the H-Wing stair is a secret slab at the end of the service alcove — and the woods\u2019 clearing \u21c4 ritual ground pair the pin had missed; before it forty-two: THE DOOR PASS — AREA CONTENT D4, 2026-09-20: fifteen draught pairs across the complexes; before it twelve: THE CAPTAIN’S SKYLIGHT between the Dutchman’s deck and its cabin — AREA CONTENT D3, 2026-09-19; before it ten: (the cave\u2019s oubliette shares a wall with Room 24601 — 2026-09-15 rev 10; THE CARGO HATCH between the Spaceship\u2019s deck and its hold — AREA CONTENT D3, 2026-09-19)');
    ...
    assert.strictEqual(pairs, 'bathroom→crawlspace coldroom→corridor_b corridor_b→coldroom crawlspace→bathroom crawlspace→thirteenth deadend→dungeon deadend→hwing_e dungeon→site_prebuilt_hollow_earth_oubliette site_prebuilt_area51_flightline→site_prebuilt_area51_ward site_prebuilt_area51_hangar→site_prebuilt_area51_ward site_prebuilt_area51_ward→site_prebuilt_area51_flightline site_prebuilt_area51_ward→site_prebuilt_area51_hangar site_prebuilt_atlantis_abyss→site_prebuilt_atlantis_temple site_prebuilt_atlantis_temple→site_prebuilt_atlantis_abyss site_prebuilt_camelot_dungeon→site_prebuilt_camelot_hall site_prebuilt_camelot_hall→site_prebuilt_camelot_dungeon site_prebuilt_camelot_keep→site_prebuilt_camelot_sky site_prebuilt_camelot_sky→site_prebuilt_camelot_keep site_prebuilt_derelict_deck→site_prebuilt_derelict_hold site_prebuilt_derelict_hold→site_prebuilt_derelict_deck site_prebuilt_downtown_cells→site_prebuilt_downtown_workings site_prebuilt_downtown_lobby→site_prebuilt_downtown_subway site_prebuilt_downtown_sewers→site_prebuilt_downtown_workings site_prebuilt_downtown_subway→site_prebuilt_downtown_lobby site_prebuilt_downtown_workings→site_prebuilt_downtown_cells site_prebuilt_downtown_workings→site_prebuilt_downtown_sewers site_prebuilt_dumb_bunker→site_prebuilt_dumb_warroom site_prebuilt_dumb_clonevats→site_prebuilt_dumb_dreamlab site_prebuilt_dumb_dreamlab→site_prebuilt_dumb_clonevats site_prebuilt_dumb_warroom→site_prebuilt_dumb_bunker site_prebuilt_fairy_forest_clearing→site_prebuilt_fairy_forest_ritual site_prebuilt_fairy_forest_deadmans→site_prebuilt_fairy_forest_redwoods site_prebuilt_fairy_forest_redwoods→site_prebuilt_fairy_forest_deadmans site_prebuilt_fairy_forest_ritual→site_prebuilt_fairy_forest_clearing site_prebuilt_fairy_forest_stair→site_prebuilt_fairy_forest_trail site_prebuilt_fairy_forest_trail→site_prebuilt_fairy_forest_stair site_prebuilt_hollow_earth_oubliette→dungeon site_prebuilt_revenge_cabin→site_prebuilt_revenge_deck site_prebuilt_revenge_deck→site_prebuilt_revenge_cabin site_prebuilt_revenge_gundeck→site_prebuilt_revenge_hold site_prebuilt_revenge_hold→site_prebuilt_revenge_gundeck site_prebuilt_strip_casino→site_prebuilt_strip_chapel site_prebuilt_strip_chapel→site_prebuilt_strip_casino site_prebuilt_vatican_courtyard→site_prebuilt_vatican_library site_prebuilt_vatican_library→site_prebuilt_vatican_courtyard thirteenth→crawlspace', 'the loops + THE CARGO HATCH + THE CAPTAIN’S SKYLIGHT (AREA CONTENT D3, 2026-09-19) + THE DOOR PASS’s fifteen pairs (AREA CONTENT D4, 2026-09-20)');
});
