...
const SPELL_LIBRARY = [
...

    {
        ...
        turretDmg: 80,
        turretRange: 2,
        desc: 'Deploy a turret on an empty tile (1 AP). It paints the nearest enemy within 2 tiles with a targeting laser — the shot lands at the end of the round for 80 damage. Max 2 per Engineer. Enemies can destroy turrets.'
    },
    {
        id: 'overclock',
        spellType: 'divine',
    ...
    },
    {
        ...
        desc: 'Call out an enemy at extreme range. Marks them for 3 turns — next hit deals +32 bonus damage.'
    },
    {
        id: 'camouflage',
        spellType: 'human',
...
const RACE_ABILITIES = {
    ...
    'giant': [
        ...
        { id: 'raceBoulderHurl', spellType: 'human', element: 'earth', name: 'Boulder Hurl',
          type: 'damage', cost: 30, dmg: 110, range: 5,
          kind: 'damage', damageType: 'physical', ignoresLineOfSight: true,
        ...
        { id: 'raceEarthenGrasp', spellType: 'human', element: 'earth', name: 'Earthen Grasp',
          ...
          kind: 'pull', damageType: 'physical', pullDistance: 2, lineOfSight: true,
          groundsFlyers: true,
          desc: 'Reach out and yank an enemy 2 tiles toward you — flyers get dragged all the way to the ground. Come down here.' },
        SHARED_RAMPART,
    ],
    'catgirl': [
    ...
    'homosapien': [
        { id: 'raceAdrenalineRush', spellType: 'human', element: 'blood', name: 'Adrenaline Rush',
          type: 'utility', cost: 20, apCost: 1, range: 0,
          kind: 'selfHeal', selfHealPct: 0.40, cleanse: 2,
          statStageBoost: { spd: 1 },
          desc: 'Tap into survival instincts. Heal 40% max HP, cleanse 2 debuffs, and gain +1 SPD. Humanity refuses to die.' }
    ],
    'pirate': [
    ...
    'cowboy': [
        ...
        { id: 'raceHighNoon', spellType: 'human', element: 'metal', name: 'High Noon',
          type: 'damage', cost: 35, dmg: 180, range: 4,
          kind: 'damage', damageType: 'physical',
          guaranteedCrit: true,
          projectileOverride: 'proj-bullet',
    ...
    'nordic': [
        ...
        { id: 'raceResonancePulse', spellType: 'alien', element: 'sonic', name: 'Resonance Pulse',
          type: 'damage', cost: 25, dmg: 110, range: 0,
    ...
    'grey': [
        ...
        { id: 'raceAbductionBeam', spellType: 'alien', element: 'light', name: 'Abduction Beam',
          type: 'damage', cost: 30, dmg: 75, range: 4, apCost: 1,
    ...
    'machine elves': [
        { id: 'raceFractalNeedle', spellType: 'alien', element: 'arcane', name: 'Fractal Needle',
          ...
          splitCount: 2, splitDmg: 72, splitRadius: 2,
        ...
        { id: 'raceBadTrip', spellType: 'alien', element: 'psychic', name: 'Bad Trip',
          type: 'damage', cost: 30, dmg: 66, range: 3,
          kind: 'damage', damageType: 'magic',
    ...
    'vampire': [
        ...
        { id: 'raceBloodThrall', spellType: 'unholy', element: 'blood', name: 'Blood Thrall',
          ...
          kind: 'debuff',
          statusEffects: [{ id: 'marked', duration: 3, bonusDamage: 30 }],
          desc: 'Mark a target as your thrall. +30 bonus damage for 3 turns. Your blood calls to me.' },
        { id: 'racePredatorDrop', spellType: 'unholy', element: 'blood', name: 'Predator Drop',
          type: 'damage', cost: 25, dmg: 60, range: 1, apCost: 1,
          kind: 'skyDrop', damageType: 'physical', carryHeight: 4, dmgPerLevel: 20,
    ...
    'quarterback': [
        { id: 'raceHailMary', spellType: 'human', element: 'wind', name: 'Hail Mary',
          type: 'damage', cost: 30, dmg: 124, range: 5,
          kind: 'damage', damageType: 'physical',
        ...
        { id: 'raceBlitz', spellType: 'human', element: 'earth', name: 'Blitz',
          type: 'damage', cost: 25, dmg: 118, range: 3,
          kind: 'dash', damageType: 'physical',
          chargeToTarget: true,
          statusEffects: [{ id: 'stagger', duration: 1 }],
