...
const RACE_BASE_STATS = {
    ...
    'nordic':        { hp: 560, mp: 142, atk: 56, def: 44, mdef: 29, move: 2, awr: 3, int: 40, spd: 5 },
    ...
    'annunaki':      { hp: 510, mp: 158, atk: 54, def: 32, mdef: 28, move: 2, awr: 3, int: 32, spd: 5 },
    ...
    'knight':        { hp: 585, mp: 80,  atk: 52, def: 42, mdef: 17, move: 2, awr: 2, int: 12, spd: 3 },
...
const RACE_ABILITIES = {
    ...
    'werewolf': [
        ...
        { id: 'raceBloodFrenzy', spellType: 'unholy', element: 'blood', name: 'Blood Frenzy',
          ...
          kind: 'damage', damageType: 'physical', dmg: 130,
    ...
    'machine elves': [
        ...
        { id: 'raceRefractBeam', spellType: 'tech', element: 'fire', name: 'Refract Beam',
          type: 'damage', cost: 26, dmg: 140, range: 5,
          kind: 'line', damageType: 'magic', lineWidth: 1,
          statusEffects: [{ id: 'burn', duration: 1 }],
    ...
    'atlantean': [
        ...
        { id: 'raceFlood', spellType: 'anomaly', element: 'water', name: 'Flood',
          type: 'damage', cost: 45, dmg: 110, range: 4, apCost: 2, cooldownRounds: 2,
    ...
    'ki fighter': [
        ...
        { id: 'raceKiWave', spellType: 'human', element: 'light', name: 'Ki Wave',
          type: 'damage', cost: 35, dmg: 165, range: 5, apCost: 2,
          kind: 'line', damageType: 'magic', lineWidth: 1,
