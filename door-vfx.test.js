...
test('every rev 3 ability has a door recipe in the registry, and every recipe owns its group', () => {
    ...
    for (const id of ['raceDoorToTheFace', 'raceAirMail', 'raceTrapdoor:set', 'raceTrapdoor', 'raceDropIn:door', 'raceBreakingEntering:door', 'raceDoorGun:shot']) {
    ...
    for (const [id, imp] of [['raceDoorToTheFace', 'raceDoorToTheFace_impact'], ['raceBreakingEntering', 'raceStompOut_impact'], ['raceAirMail', 'raceAirMail_impact'], ['raceTrapdoor', 'raceTrapdoor_impact'], ['raceDropIn', 'raceDropIn_impact']]) {
