...
test('the sheet: seventeen of the eighteen terrain rooms carry a floor plan — the cave chambers cellular automata, the open woods clearings + corridors; the storm drain (a culvert) keeps its box', () => {
    assert.equal(PLANNED.length, 31, PLANNED.join(','));   // + AREA 51's three (2026-09-18: the hangar and the white rooms on `halls`, the flight line on `rooms`)   // + D.U.M.B.'s six `halls` plans (2026-09-17: five parts on Room 555 + CERN's ring; the war room is its own floor)   // + THE STRIP's streets, − the mall (its plan went in the third pass, 2026-09-17)   // + CYBERPUNK CITY's grid (the second pass, 2026-09-17), + THE DIVINE STAIR's four, + THE VATICAN's archive and cortile (2026-09-17; the basilica and the observatory are their own floors), + DISASTER CITY's streets and mall (the `city` kind)
